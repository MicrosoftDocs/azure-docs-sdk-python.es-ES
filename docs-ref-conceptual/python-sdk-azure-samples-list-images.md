...
ms.locfileid: "67534434"
---
# <a name="list-images"></a><span data-ttu-id="c61d1-103">Lista de imágenes</span><span class="sxs-lookup"><span data-stu-id="c61d1-103">List images</span></span>

<span data-ttu-id="c61d1-104">Use el código siguiente para imprimir todas las imágenes disponibles que puede usar para crear máquinas virtuales, incluidas todas las SKU y versiones.</span><span class="sxs-lookup"><span data-stu-id="c61d1-104">Use the following code to print all of the available images to use for creating virtual machines, including all skus and versions.</span></span>
